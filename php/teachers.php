    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
      <ul class="navbar-nav">
        ...
        <li class="nav-item dropdown"> <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          ...
          <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink"> <a class="dropdown-item" href="administrators.php">Администраторы</a> <a class="dropdown-item" href="#">Преподаватели</a> <a class="dropdown-item" href="students.php">Студенты старше 21</a> 
          </div>
        </li>
      </ul>
    </div>
      ...
      <div class="container">
        <div class="w-10 p-15">
          <div class="card-group">
            <?php foreach ($arrScholaProgeniumUsers as  $userTeacher)
            if ($userTeacher['group'] === 'Преподаватель'): ?>
              <div class="card text-white bg-dark mb-3" style="margin:15px; margin-top: 15%; "> <img src="../images/2.png" class="card-img-top" alt="Шапка">
                <div class="card-body">
                  <h5 class="card-title" style="text-align: center;">Преподаватель:</h5>
                  ...
                  <p class="card-text" style="font-size: 12px; text-align: justify;">
                    <?= $userTeacher['information'] ?><small class="text-muted"></small></p>
                </div>
              </div>
              <?php endif ?>
          </div>
